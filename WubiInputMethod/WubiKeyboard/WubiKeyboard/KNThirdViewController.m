...
- (IBAction)dismissButtonDidTouch:(id)sender {
  ...
  if ([self.parent respondsToSelector:@selector(dismissSemiModalView)]) {
    [self.parent dismissSemiModalView];
  }
...
- (IBAction)addToFrind:(id)sender {
    NSUserDefaults* userDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.com.jeffery.wubikeyboard"];
    NSLog(@"%@", self.themeId);
    [userDefaults setObject:self.themeId forKey:@"theme"];
